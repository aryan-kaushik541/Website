      ...
      <section className="min-w-56">
        ...
        <div className='flex md:flex-row justify-evenly  flex-col gap-4 px-8 '>
          ...
          <div className="md:w-1/2   md:mt-4">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d130021.71595378166!2d76.9890525829162!3d28.617038212632057!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390d04ba6b064d0f%3A0xf609cdf712fe603e!2sJanakpuri%2C%20New%20Delhi%2C%20Delhi!5e0!3m2!1sen!2sin!4v1741946557274!5m2!1sen!2sin" allowFullScreen="" loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="w-full md:h-96 mb-6"></iframe>
          </div>
        </div>
      </section>
      <Footer/>
